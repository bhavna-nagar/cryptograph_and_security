'''problem statement: Write a program that can perform a letter frequency attack on an additive cipher without
  human intervention. Your software should produce possible plain text in rough order of likelihood. It would be good if your
  user interface allows user to specify " Give me top 10 possible plain texts"'''
#function to generate 10 plain text correspoinding to given cipher text,take input an encrypted text encrypted by additive scheme
...
def main():
    print("****enter only Upper case letters(no symbols,number,lower case letters****")
    response="yes"
    while response=="yes":
